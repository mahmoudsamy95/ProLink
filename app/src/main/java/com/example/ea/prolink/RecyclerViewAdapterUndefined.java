...
public class RecyclerViewAdapterUndefined extends RecyclerView.Adapter<RecyclerViewAdapterUndefined.MyViewHolder> {
    Context mContext;
    List<Appointment> mData;

    public RecyclerViewAdapterUndefined(Context mContext, List<Appointment> mData) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view;
        view = LayoutInflater.from(mContext).inflate(R.layout.item_undefined_appointment,parent,false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.cv_undefined_appointment.setTag(position);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private CardView cv_undefined_appointment;
        ...
        public MyViewHolder(View itemView) {
            ...
            cv_undefined_appointment = (CardView)itemView.findViewById(R.id.cv_undefined_appointment);
