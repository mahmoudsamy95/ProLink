...
public class RejectedAppointmentActivity extends AppCompatActivity {

    RecyclerView recyclerView;
    List<Appointment> appointmentList;
    RecyclerViewAdapterRejected recyclerViewAdapterRejected;
                ...
                try{
                    ...
                    for(int i=0;i<jsonArray.length();i++) {
                        ...
                        if (status.equals(givenStatus)) {
                            ...
                            recyclerViewAdapterRejected = new RecyclerViewAdapterRejected(getApplicationContext(),appointmentList);
                            recyclerView.setAdapter(recyclerViewAdapterRejected);
                        }
                    }
