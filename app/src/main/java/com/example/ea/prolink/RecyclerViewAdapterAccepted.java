...
public class RecyclerViewAdapterAccepted extends RecyclerView.Adapter<RecyclerViewAdapterAccepted.MyViewHolder> {
    Context mContext;
    List<Appointment> mData;

    public RecyclerViewAdapterAccepted(Context mContext, List<Appointment> mData) {
